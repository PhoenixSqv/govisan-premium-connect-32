  ...
  return (
    <section id="solutions" className="section--wm wm--solutions py-20 bg-secondary/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Wiredscore Section */}
        {content.wiredscore && (
          <div className="bg-white rounded-2xl p-8 shadow-premium mb-16 text-center">
            <div className="w-16 h-16 bg-govisan-gold/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
              <Award className="h-8 w-8 text-govisan-gold" />
            </div>
            <h3 className="text-2xl font-bold text-foreground mb-4">
              {content.wiredscore.title}
            </h3>
            <p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              {content.wiredscore.description}
            </p>
          </div>
        )}
