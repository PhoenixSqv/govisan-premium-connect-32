          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex space-x-4">
                {socialLinks.map(social => <a key={social.name} href={social.href} className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-govisan-gold transition-colors group">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-6">
                {offices.map(office => <div key={office.region} className="border-l-2 border-govisan-gold/30 pl-4">
