...
const InsightsSection = () => {
  ...
  return (
    <section id="insights" className="section--wm wm--insights py-20 bg-secondary/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Stay ahead with our expert insights on hospitality technology trends, best practices, and innovative solutions shaping the future of luxury hotels.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <Button 
            onClick={() => handleNavClick('#contact')}
            className="bg-govisan-gold hover:bg-govisan-gold/90 text-white font-semibold px-8 py-4 text-lg"
          >
            Explore Insights
